...
- Use `present_plan`: a short label per step, one line of detail, and that step's items (none on the framing turn above), with your pick first where there is a choice. Keep the prose around it to a sentence or two.
